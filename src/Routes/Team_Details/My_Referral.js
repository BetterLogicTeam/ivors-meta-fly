...
const My_Referral = () => {
    ...
    const referral_API = async () => {
        ...
        try {
            ...
            let uid = res?.uid;
            let responce = await API?.post(`/myReferral`, {
                "uid": uid,
                "fdate": `${fromDate}`,
                "tdate": `${toDate}`
            });
    ...
    var [referral_income, set_referral_income] = new useState({
        cols: [
            ...
            { Header: 'Wallet Address', accessor: 'accountnumber' },
            { Header: 'Package Amount', accessor: 'mintingamount' },
            { Header: 'Reg. Date & Time', accessor: 'edate' }
        ]
    });
    return (
            ...
            <div className="col-md-11 py-3">
                ...
                <div class="row mt-3" style={{ marginLeft: "10px" }}>
                    <div class="col-md-3 ref-ip">
                        ...
                        <input type="date" name="from_date" id="fromdate" placeholder="dd/mm/yyyy" class="select-system" onChange={(e) => setFromDate(e.target.value)} />
                    </div><br /><br />
                    <div class="col-md-3 ref-ip">
                        <label>Enter To Date</label>
                        <input type="date" name="to_date" id="todate" placeholder="dd/mm/yyyy" class="select-system" onChange={(e) => setToDate(e.target.value)} />
                    </div><br /><br />
