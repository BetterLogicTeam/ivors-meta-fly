...
const Withdrawal_Share_Bonus = () => {
    ...
    const referral_API = async () => {
        ...
        try {
            ...
            let uid = res?.uid;
            let responce = await API?.get(`/nftRewardIncome?uid=${uid}&fdate=${fromDate}&tdate=${toDate}`);
...
{loader == true ? <Spinner /> : <></>}
            <div className="col-md-11 py-3">
                <PagePath data={{ page_name: "NFT Reward Income", page_path: "All Income / NFT Reward Income" }} />
