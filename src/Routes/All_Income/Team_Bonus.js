...
export default function Team_Bonus() {
    ...
    var [my_referral, set_my_referral] = new useState({
        cols: [
            ...
            { Header: 'Token ID', accessor: 'package' },
            { Header: 'Income', accessor: 'total_active_team' },
            // { Header: 'Sports Bonus', accessor: 'Sports_Bonus' },
            { Header: ' Date & Time', accessor: 'activation_date' },
            // { Header: 'Net Income', accessor: 'NetI_ncome' },
            // { Header: 'Activation Date Time', accessor: 'activation_date' },
        ],
        rows: [
            { sr: '1',  package: '7', NetI_ncome: '100 USD', Sports_Bonus: '500', activation_date: '12/11/2021 1:40:08 PM', total_active_team: '0' },
            { sr: '2',  package: '7', NetI_ncome: '100 USD', Sports_Bonus: '500', activation_date: '12/11/2021 1:40:08 PM', total_active_team: '0' },
            { sr: '3',  package: '7', NetI_ncome: '100 USD', Sports_Bonus: '100', activation_date: '12/11/2021 1:40:08 PM', total_active_team: '0' },
             ]
    });
  return (
    <div>
        <div className="row justify-content-center" style={{ height: '70vh' }}>
            <div className="col-md-11 py-3">
                <PagePath data={{ page_name: "Total NFT Income", page_path: "All Income / Total NFT Income" }} />
